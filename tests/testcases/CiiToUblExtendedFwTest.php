...
class CiiToUblExtendedFwTest extends TestCase
{
    ...
    public function testAccountingSupplierParty(): void
    {
        ...
        $this->assertXPathValueWithIndex('/ubl:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name', 0, "Rohstoff AG Salzgitter");
    ...
    public function testAccountingCustomerParty(): void
    {
        ...
        $this->assertXPathValueWithIndex('/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name', 0, "Metallbau Leipzig GmbH & Co. KG");

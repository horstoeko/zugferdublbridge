...
final class CiiToUblDiscountTest extends TestCase
{
    use HandlesXmlTests;

    public function testLoadAndConvert(): void
    {
        self::$document = XmlConverterCiiToUbl::fromFile(__DIR__ . '/../assets/cii/1_cii_discount.xml')->enableAutomaticMode()->convert();
